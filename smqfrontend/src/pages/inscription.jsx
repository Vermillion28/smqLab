                    ...
                    <div className={styles.formContainer}>
                        <div className={styles.formCard}>
                            <div className={styles.formHeader}>
                                <h2 className={styles.formTitle}>Créer votre compte Responsable Qualité</h2>
                                <p className={styles.formSubtitle}>Rejoignez notre plateforme de gestion de la qualité</p>
                            </div>
                            ...
                            <form id="signupForm" className={styles.signupForm} onSubmit={handleSubmit}>
                                    ...
                                    <div className={styles.formRow}>
                                        <div>
                                            ...
                                            <div className={styles.inputContainer}>
                                                ...
                                                <input type="text" id="name" name="name" className={styles.formInput} placeholder="Nom d'utilisateur" value={formData.name} onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className={styles.formGroup}>
                                    ...
                                    <div className={styles.inputContainer}>
                                        ...
                                        <input type="email" id="email" name="email" className={styles.formInput} placeholder="username@email.com" value={formData.email} onChange={handleInputChange} required />
                                    </div>
                                </div>
                                ...
                                <div className={styles.formGroup}>
                                    <label className={styles.formLabel} htmlFor="confirmPassword">Confirmer le mot de passe</label>
                                    <div className={styles.inputContainer}>
                                        <AiOutlineLock className={styles.inputIcon} />
                                        <input type={showConfirmPassword ? "text" : "password"} id="confirmPassword" name="confirmPassword" className={styles.formInput} placeholder="••••••••" value={formData.confirmPassword} onChange={handleInputChange} required/>
                                        <button type="button" className={styles.passwordToggle} onClick={() => togglePassword('confirmPassword')}>
                                            <FaRegEyeSlash />
                                        </button>
                                    </div>
                                </div>

                                <button type="submit" className={styles.submitBtn}>Créer mon compte QMS</button>

                                <div className={styles.loginLink}>Déjà un compte ? <a href="/connexion">Se connecter</a></div>
                            </form>
